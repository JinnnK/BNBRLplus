...
def get_args():
    ...
    parser.add_argument(
        '--output_dir', type=str, default='trained_models/BNBRL+')
    ...
    parser.add_argument(
        '--load-path', default='trained_models/prototype_gaussian_model_0_copy/checkpoints/20832.pt',
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=True,
        help='use bayesian neural network')
    """type of policy of blind spot
    BNBRL+ : Bayesian Neural Network + Attention module
    BNBRL : Bayesian Neural Network
    BNDNN : Deep Neural Network
    none : no policy for blind spot"""
    parser.add_argument(
        '--bnn_policy', type=str, default='BNBRL+')
    parser.add_argument(
        '--hidden_dim',
        type=int,
        default=128,
    ...
    # for srnn only
    # RNN size
    # 192 for BNDNN, BNBRL, and BNBRL+. 128 for none.
    parser.add_argument('--human_node_rnn_size', type=int, default=192,
