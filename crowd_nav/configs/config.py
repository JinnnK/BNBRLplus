...
class Config(object):
    ...
    reward.belief_discount_factor = 0.9 # control the discount factor of belief
    ...
    # conditions for Belief aided Navigation
    robot.belief = True
    sim.belief_method = 'inferred' # 'inferred' or 'const_vel'
    # number of humans in the environment
    sim.human_num = 20
    # radius of belief in the environment
    sim.belief_radius = 0.5
    # FOV = values * PI
    robot.FOV = 9/6
    # number of trackers in the environment. must be <= sim.human_num
    sim.tracker = False
    sim.tracker_num = 1
    # blink the robot or not
    robot.blink = False
    robot.blink_period = 0.5    # must be times of time_step
    robot.blink_time = 2.5  # blink for time_step. must be times of time_step. for now timestep = 0.25
